...
public class MemberTest extends TestCase{
	...
	protected List<Member> members2;
	  ...
	  @Override
	    ...
	    {
	        super.setUp();
	        p =  new ProblemReader().read("src/main/resources/december2015.json");
	...
	public void testEqualTrue() {
		GroupVariable var1 = new GroupVariable(p.getDescription(), new ArrayList<>(members1));
		GroupVariable var2 = new GroupVariable(p.getDescription(), new ArrayList<>(members2));
