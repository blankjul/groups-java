...
public class RelationTable extends JTable {
    ...
    public void update(Member m) {
        ...
        for(Member other : Storage.desc.getMembers()) {
            ...
            else if (m.getPreferences().contains(other)) model.addRow(new Object[] {"ja", other.getName()});
            else if (m.getRejections().contains(other)) model.addRow(new Object[] {"nein", other.getName()});
            else model.addRow(new Object[] {"neutral", other.getName()});
        }
