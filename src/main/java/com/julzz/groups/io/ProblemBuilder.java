...
public class ProblemBuilder {
    ...
    protected transient Map<String, PlainObjectMember> hash = new HashMap<>();
    ...
    public Problem build() {
        ...
        for (PlainObjectMember pojo : members) {
            ...
            for (String pref : pojo.preferences) {
                if (!objMembers.containsKey(pref)) {
                    memberNotFoundButAdded(pref, pojo.name);
                }
            ...
            for (String rej : pojo.rejections) {
                if (!objMembers.containsKey(rej)) {
                    memberNotFoundButAdded(rej, pojo.name);
                }
